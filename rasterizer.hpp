...
namespace rst
{
    ...
    // defined by kohei0802. perspective correct interpolation constants
    struct PerspInterpConsts3d
    {
        ...
        // 3 common constants for denominator calculation
        float w0_inv;
        float w1_inv;
        float w2_inv;
    };

    struct PerspInterpConsts2d
    {
        // constants on the numerator
        Eigen::Vector2f u0w0;
        Eigen::Vector2f u1w1;
    ...
    public:
        ...
        // void get_texture() {return texture;}
